// lib/features/tv_shows/presentation/screens/tv_detail_screen.dart
...
class TvDetailScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final String? backdropPath = detailsAsync.valueOrNull?['backdrop_path'];
                    ...
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: isLoading ? null : () async {
                                ...
                                final totalEpisodes =
                                    (detailsAsync.valueOrNull?['number_of_episodes'] as int?) ?? 0;
                                final seasons =
                                    (detailsAsync.valueOrNull?['seasons'] as List<dynamic>?) ?? [];
